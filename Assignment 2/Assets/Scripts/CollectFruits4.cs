...
public class CollectFruits4 : MonoBehaviour
{
        ...
        if (colorChanging)
        {
            ...
            if (transform.parent.gameObject != parent)
            {
                ...
                if (myTimer >= 3f && inter == true)
                {
                    ...
                    Vector3 TeleportPose = new Vector3((bottom.transform.position.x), (bottom.transform.position.y + 0.2f), bottom.transform.position.z );
