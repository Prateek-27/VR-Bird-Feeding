...
public class GiveFruits4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bub = GameObject.Find("/Zones/Zone5/zone5Bubble");
    ...
    void Update()
    {
        ...
        // Feed it 
        inzonebub = player.GetComponent<Collision>().inZone5;
        onzonebase = player.GetComponent<Collision>().onZone5base;
        bird1Col = bub.GetComponent<birdCollision5>().bird5;
        bird2Col = bub.GetComponent<birdCollision5>().bird55;
        ...
        if (onzonebase == true && inhand == true)
        {
            ...
            {
                Debug.Log("DESTROY!");
                fruitbasket.GetComponent<FruitCounter>().peanutCount -= 1f;
                fruitbasket.GetComponent<FruitCounter>().peanutFed += 1f;
                Destroy(gameObject);
            }
        }
