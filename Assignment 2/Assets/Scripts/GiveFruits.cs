...
public class GiveFruits : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bub = GameObject.Find("/Zones/Zone1/zone1Bubble");
        scale = transform.localScale;
        counter = 0;
        //inzonebub = player.GetComponent<Collision>().inZone1;
        //onzonebase = player.GetComponent<Collision>().onZone1base;
    ...
    void Update()
    {
        ...
        inzonebub = player.GetComponent<Collision>().inZone1;
        onzonebase = player.GetComponent<Collision>().onZone1base;
        bird1Col = bub.GetComponent<birdCollision1>().bird1;
        bird2Col = bub.GetComponent<birdCollision1>().bird11;
        ...
        if (onzonebase == true && inhand == true)
        {
            ...
            {
                Debug.Log("DESTROY!");
                fruitbasket.GetComponent<FruitCounter>().appleCount -= 1f;
                fruitbasket.GetComponent<FruitCounter>().appleFed += 1f;
                Destroy(gameObject);
            }
        }
        
        //Debug.Log("APPLE: " + fruitbasket.GetComponent<FruitCounter>().appleCount);
       // Debug.Log("COUNTER FROM COLLECT FRUIT: " + counter);
