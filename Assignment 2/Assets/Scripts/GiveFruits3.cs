...
public class GiveFruits3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bub = GameObject.Find("/Zones/Zone4/zone4Bubble");
    ...
    void Update()
    {
        ...
        // Feed it 
        inzonebub = player.GetComponent<Collision>().inZone4;
        onzonebase = player.GetComponent<Collision>().onZone4base;
        bird1Col = bub.GetComponent<birdCollision4>().bird4;
        bird2Col = bub.GetComponent<birdCollision4>().bird44;
        ...
        if (onzonebase == true && inhand == true)
        {
            ...
            {
                Debug.Log("DESTROY!");
                fruitbasket.GetComponent<FruitCounter>().peachCount -= 1f;
                fruitbasket.GetComponent<FruitCounter>().peachFed += 1f;
                Destroy(gameObject);
            }
        }
